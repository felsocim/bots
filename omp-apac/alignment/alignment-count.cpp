...
#pragma omp task default(shared) depend(in : A, B, N, gh, seq1, seq2, tb, te) depend(inout : hh) firstprivate(j) if (__apac_count_ok)
        {
...
#pragma omp task default(shared) depend(in : A, B, s, seq1, seq2) depend(inout : hh) firstprivate(j, i) if (__apac_count_ok)
        {
...
#pragma omp task default(shared) depend(in : A, B, M, N, displ, g, gh, last_print, midi, midj, print_ptr, seq1, seq2, tb, te) depend(inout : displ[0], last_print[0], print_ptr[0]) if (__apac_count_ok)
      {
...
#pragma omp task default(shared) depend(in : def_aa_xref) depend(inout : maxres) if (__apac_count_ok)
    {
...
#pragma omp task default(shared) depend(in : g[0], gh[0], m, n, seq1[0], seq2[0], seq_array, seq_array[*seq1], seq_array[*seq1][0], seq_array[*seq2], seq_array[*seq2][0], se1, se2, maxscore, seq1, seq2, g, gh) depend(inout : maxscore[0], se1[0], se2[0]) if (__apac_count_ok)
          {
...
#pragma omp task default(shared) depend(in : g[0], gh[0], maxscore[0], se1[0], se2[0], seq1[0], seq2[0], seq_array, seq_array[*seq1], seq_array[*seq1][0], seq_array[*seq2], seq_array[*seq2][0], se1, se2, sb1, sb2, maxscore, seq1, seq2, g, gh) depend(inout : sb1[0], sb2[0]) if (__apac_count_ok)
          {
...
#pragma omp task default(shared) depend(in : displ, g[0], gh[0], sb1[0], sb2[0], se1[0], se2[0], seq1[0], seq2[0], se1, se2, sb1, sb2, seq1, seq2, g, gh, print_ptr, last_print) depend(inout : displ[0], last_print[0], mm_score, print_ptr[0]) if (__apac_count_ok)
          {
...
#pragma omp task default(shared) depend(inout : se1) if (__apac_count_ok)
          {
            delete se1;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : se2) if (__apac_count_ok)
          {
            delete se2;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : sb1) if (__apac_count_ok)
          {
            delete sb1;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : sb2) if (__apac_count_ok)
          {
            delete sb2;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : maxscore) if (__apac_count_ok)
          {
            delete maxscore;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : seq1) if (__apac_count_ok)
          {
            delete seq1;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : seq2) if (__apac_count_ok)
          {
            delete seq2;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : g) if (__apac_count_ok)
          {
            delete g;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : gh) if (__apac_count_ok)
          {
            delete gh;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : displ) if (__apac_count_ok)
          {
            delete[] displ;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : print_ptr) if (__apac_count_ok)
          {
            delete print_ptr;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(inout : last_print) if (__apac_count_ok)
          {
            delete last_print;
            if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) if (__apac_count_ok)
    {
      pairalign();
      if (__apac_count_ok) {
#pragma omp atomic
