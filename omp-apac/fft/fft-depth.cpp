...
#pragma omp taskgroup
    {
      ...
      if (b - a < 16) {
        ...
        int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : a, ab[0], b, in, m, out, r, ab) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp taskgroup
    {
      if (i == i1 - 1) {
#pragma omp task default(shared) depend(in : W, W[0], i, in, in[0], m, nW, nWdn, out, out[0], r) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(in : W, W[0], i, i1, i2[0], in, m, nW, nWdn, out, r, i2) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(inout : i2) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
    ...
    fft_twiddle_gen_seq(i, i1, in, out, W, nW, nWdn, r, m);
  }
}
...
#pragma omp taskgroup
    {
      ...
      if (b - a < 128) {
        ...
        int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : W, a, ab[0], b, in, in[0], m, nW, nWdn, out, ab) depend(inout : W[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_twiddle_2_seq(a, b, in, out, W, nW, nWdn, m);
  }
}
...
#pragma omp taskgroup
    {
      ...
      if (b - a < 128) {
        ...
        int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : a, ab[0], b, in, m, out, ab) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_unshuffle_2_seq(a, b, in, out, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_twiddle_4_seq(a, b, in, out, W, nW, nWdn, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_unshuffle_4_seq(a, b, in, out, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_twiddle_8_seq(a, b, in, out, W, nW, nWdn, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_unshuffle_8_seq(a, b, in, out, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_twiddle_16_seq(a, b, in, out, W, nW, nWdn, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_unshuffle_16_seq(a, b, in, out, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_twiddle_32_seq(a, b, in, out, W, nW, nWdn, m);
  }
}
...
#pragma omp task default(shared) depend(inout : ab) firstprivate(__apac_depth_local) if (__apac_depth_ok)
    ...
    fft_unshuffle_32_seq(a, b, in, out, m);
  }
}
...
#pragma omp taskgroup
    {
      ...
      int k;
      if (n == 32) {
#pragma omp task default(shared) depend(in : in, out) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp taskwait
      ...
      if (n == 4) {
#pragma omp task default(shared) depend(in : in, in[0], out) depend(inout : out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp taskwait
      ...
      if (r < n) {
        if (r == 32) {
#pragma omp task default(shared) depend(in : in, m, out) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
          {
            if (__apac_depth_ok) {
              __apac_depth = __apac_depth_local + 1;
            }
...
#pragma omp task default(shared) depend(in : in, m, out, r) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
                  {
                    if (__apac_depth_ok) {
                      __apac_depth = __apac_depth_local + 1;
                    }
        ...
        for (k = 0; k < n; k += m) {
#pragma omp task default(shared) depend(in : W, factors, factors[0], in, in[0], nW, out, out[0]) depend(inout : W[0]) firstprivate(__apac_depth_local, m, k) if (__apac_depth_ok)
          {
            if (__apac_depth_ok) {
              __apac_depth = __apac_depth_local + 1;
            }
      ...
      if (r == 2) {
#pragma omp task default(shared) depend(in : W, in, in[0], m, n, nW, out) depend(inout : W[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(in : W, W[0], in, m, n, nW, out, r) depend(inout : in[0], out[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
                {
                  if (__apac_depth_ok) {
                    __apac_depth = __apac_depth_local + 1;
                  }
    ...
    fft_aux_seq(n, in, out, factors, W, nW);
  }
}
...
#pragma omp task default(shared) depend(in : n) depend(inout : W, W[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
      ...
      while (l > 1 || s) {
#pragma omp task default(shared) depend(in : l) depend(inout : r) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
