...
#pragma omp task default(shared) depend(in : W, a, ab[0], b, n, ab) depend(inout : W[0])
      {
        compute_w_coefficients(n, a, *ab, W);
        compute_w_coefficients(n, *ab + 1, b, W);
      }
#pragma omp task default(shared) depend(inout : ab)
      delete ab;
    }
  __apac_exit:;
  }
...
#pragma omp taskgroup
  {
    ...
    if (b - a < 16) {
      ...
      int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : a, ab[0], b, in, m, out, r, ab) depend(inout : in[0], out[0])
      {
...
#pragma omp taskgroup
  {
    if (i == i1 - 1) {
#pragma omp task default(shared) depend(in : W, W[0], i, in, in[0], m, nW, nWdn, out, out[0], r)
      fft_twiddle_gen1(in + i, out + i, W, r, m, nW, nWdn * i, nWdn * m);
    } else {
      int* i2 = new int((i + i1) / 2);
#pragma omp task default(shared) depend(in : W, W[0], i, i1, i2[0], in, m, nW, nWdn, out, r, i2) depend(inout : in[0], out[0])
      {
        fft_twiddle_gen(i, *i2, in, out, W, nW, nWdn, r, m);
        fft_twiddle_gen(*i2, i1, in, out, W, nW, nWdn, r, m);
      }
#pragma omp task default(shared) depend(inout : i2)
      delete i2;
    }
  __apac_exit:;
  }
...
#pragma omp taskgroup
  {
    ...
    if (b - a < 128) {
      ...
      int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : W, a, ab[0], b, in, in[0], m, nW, nWdn, out, ab) depend(inout : W[0], out[0])
      {
...
#pragma omp taskgroup
  {
    ...
    if (b - a < 128) {
      ...
      int* ab = new int((a + b) / 2);
#pragma omp task default(shared) depend(in : a, ab[0], b, in, m, out, ab) depend(inout : in[0], out[0])
      {
...
#pragma omp taskgroup
  {
    ...
    int k;
    if (n == 32) {
#pragma omp task default(shared) depend(in : in, out) depend(inout : in[0], out[0])
      fft_base_32(in, out);
#pragma omp taskwait
      goto __apac_exit;
    }
...
#pragma omp taskwait
    ...
    if (n == 4) {
#pragma omp task default(shared) depend(in : in, in[0], out) depend(inout : out[0])
      fft_base_4(in, out);
#pragma omp taskwait
      goto __apac_exit;
    }
...
#pragma omp taskwait
    ...
    if (r < n) {
      if (r == 32) {
#pragma omp task default(shared) depend(in : in, m, out) depend(inout : in[0], out[0])
...
#pragma omp task default(shared) depend(in : in, m, out, r) depend(inout : in[0], out[0])
      ...
      for (k = 0; k < n; k += m) {
#pragma omp task default(shared) depend(in : W, factors, factors[0], in, in[0], nW, out, out[0]) depend(inout : W[0]) firstprivate(m, k)
        fft_aux(m, out + k, in + k, factors + 1, W, nW);
      }
    }
    if (r == 2) {
#pragma omp task default(shared) depend(in : W, in, in[0], m, n, nW, out) depend(inout : W[0], out[0])
...
#pragma omp task default(shared) depend(in : W, W[0], in, m, n, nW, out, r) depend(inout : in[0], out[0])
...
#pragma omp task default(shared) depend(in : n) depend(inout : W, W[0])
    {
...
#pragma omp task default(shared) depend(in : W, factors, in, n, out) depend(inout : W[0], factors[0], in[0], out[0])
    {
