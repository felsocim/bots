...
#pragma omp task default(shared) depend(in : cell_width, nb_cells_per_dim, src_particles_symb, src_particles_symb[idxPart]) depend(inout : cell_idx[0]) firstprivate(__apac_depth_local, idxPart) if (__apac_count_ok || __apac_depth_ok) firstprivate(cell_idx)
        {
...
#pragma omp task default(shared) depend(inout : cell_idx[0]) if (__apac_count_ok || __apac_depth_ok) firstprivate(cell_idx, __apac_depth_local)
        {
          if (__apac_count_ok || __apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(in : me[0], nb_cells_per_dim, particles_forces, particles_forces[*me], particles_symb, particles_symb[0], particles_symb[0][0], particles_symb[*me], particles_symb[*me][0], sizes, sizes[0], sizes[*me]) depend(inout : particles_forces[*me][0]) firstprivate(__apac_depth_local, idx_z, idx_y, idx_x) if (__apac_count_ok || __apac_depth_ok) firstprivate(me)
            {
              if (__apac_count_ok || __apac_depth_ok) {
                __apac_depth = __apac_depth_local + 1;
              }
...
#pragma omp task default(shared) depend(inout : me[0]) if (__apac_count_ok || __apac_depth_ok) firstprivate(me, __apac_depth_local)
            {
              if (__apac_count_ok || __apac_depth_ok) {
                __apac_depth = __apac_depth_local + 1;
              }
...
#pragma omp task default(shared) depend(in : cell_width, nb_cells_per_dim, particles_symb) depend(inout : up_cell_idx[0]) firstprivate(__apac_depth_local) if (__apac_count_ok || __apac_depth_ok) firstprivate(up_cell_idx)
              {
                if (__apac_count_ok || __apac_depth_ok) {
                  __apac_depth = __apac_depth_local + 1;
                }
...
#pragma omp task default(shared) depend(inout : up_cell_idx[0]) if (__apac_count_ok || __apac_depth_ok) firstprivate(up_cell_idx, __apac_depth_local)
              {
                if (__apac_count_ok || __apac_depth_ok) {
                  __apac_depth = __apac_depth_local + 1;
                }
...
#pragma omp task default(shared) depend(in : box_width, cell_width, nb_cells_per_dim, particles_forces, particles_symb, sizes, time_step) depend(inout : particles_forces[0], particles_forces[0][0], particles_forces[0][0][0], particles_symb[0], particles_symb[0][0], particles_symb[0][0][0], sizes[0], sizes[0][0]) firstprivate(__apac_depth_local) if (__apac_count_ok || __apac_depth_ok)
        {
          if (__apac_count_ok || __apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
