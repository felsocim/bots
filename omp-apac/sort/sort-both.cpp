...
#pragma omp task default(shared) depend(in : low[0], quarter, size) depend(inout : low, tmp) firstprivate(__apac_depth_local) if ((__apac_count_ok || __apac_depth_ok) && 0.00238891712137 + (size - 3 * quarter) * 5.3448181656e-06 > __apac_cutoff)
      {
