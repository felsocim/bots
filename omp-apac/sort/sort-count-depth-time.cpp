...
#pragma omp task default(shared) depend(in : low[0], quarter, size) depend(inout : low, tmp) firstprivate(__apac_depth_local) if ((__apac_count_ok || __apac_depth_ok) && 0.0022128385825 + quarter * 3.20369846234e-06 > __apac_cutoff)
      {
