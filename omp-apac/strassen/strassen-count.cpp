...
#pragma omp task default(shared) depend(in : AdditiveMode, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0]) if (__apac_count_ok)
      {
...
#pragma omp task default(shared) depend(in : B, B[0], QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], C, C[0]) if (__apac_count_ok)
        {
...
#pragma omp task default(shared) depend(in : QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0]) if (__apac_count_ok)
        {
...
#pragma omp task default(shared) depend(in : B, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, C, C[0]) if (__apac_count_ok)
      {
...
#pragma omp task default(shared) depend(in : A, B, C, MatrixSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A[0], B[0], C[0]) if (__apac_count_ok)
      {
        MultiplyByDivideAndConquer(C, A, B, MatrixSize, RowWidthC, RowWidthA, RowWidthB, 0);
        if (__apac_count_ok) {
#pragma omp atomic
...
#pragma omp task default(shared) depend(in : A, B, Depth, QuadrantSize, RowWidthA, RowWidthB) depend(inout : A[0], B[0], Heap) if (__apac_count_ok)
    {
...
#pragma omp task default(shared) depend(in : Depth, QuadrantSize) depend(inout : A, B, Heap) if (__apac_count_ok)
    {
...
#pragma omp task default(shared) depend(in : Depth, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, B, C, C[0]) if (__apac_count_ok)
    {
...
#pragma omp task default(shared) depend(in : A, B, C, n) depend(inout : A[0], B[0], C[0]) if (__apac_count_ok)
    {
