...
#pragma omp taskgroup
    {
      ...
      C11 = C10 + QuadrantSize;
      if (QuadrantSize > 16) {
#pragma omp task default(shared) depend(in : AdditiveMode, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
        ...
        if (AdditiveMode) {
#pragma omp task default(shared) depend(in : B, B[0], QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], C, C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
          {
            if (__apac_depth_ok) {
              __apac_depth = __apac_depth_local + 1;
            }
...
#pragma omp task default(shared) depend(in : QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
          {
            if (__apac_depth_ok) {
              __apac_depth = __apac_depth_local + 1;
            }
...
#pragma omp task default(shared) depend(in : B, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, C, C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp taskgroup
    {
      ...
      PTR RowIncrementC = RowWidthC - QuadrantSize << 3;
      if (MatrixSize <= bots_app_cutoff_value) {
#pragma omp task default(shared) depend(in : A, B, C, MatrixSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A[0], B[0], C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
        {
          if (__apac_depth_ok) {
            __apac_depth = __apac_depth_local + 1;
          }
...
#pragma omp task default(shared) depend(in : A, B, Depth, QuadrantSize, RowWidthA, RowWidthB) depend(inout : A[0], B[0], Heap) firstprivate(__apac_depth_local) if (__apac_depth_ok)
      {
        if (__apac_depth_ok) {
          __apac_depth = __apac_depth_local + 1;
        }
...
#pragma omp task default(shared) depend(in : Depth, QuadrantSize) depend(inout : A, B, Heap) firstprivate(__apac_depth_local) if (__apac_depth_ok)
      {
        if (__apac_depth_ok) {
          __apac_depth = __apac_depth_local + 1;
        }
...
#pragma omp task default(shared) depend(in : Depth, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, B, C, C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
      {
        if (__apac_depth_ok) {
          __apac_depth = __apac_depth_local + 1;
        }
...
#pragma omp task default(shared) depend(in : A, B, C, n) depend(inout : A[0], B[0], C[0]) firstprivate(__apac_depth_local) if (__apac_depth_ok)
      {
        if (__apac_depth_ok) {
          __apac_depth = __apac_depth_local + 1;
        }
