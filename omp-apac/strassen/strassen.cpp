...
#pragma omp taskgroup
  {
    ...
    if (QuadrantSize > 16) {
#pragma omp task default(shared) depend(in : AdditiveMode, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0])
      {
      ...
      if (AdditiveMode) {
#pragma omp task default(shared) depend(in : B, B[0], QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], C, C[0])
        {
...
#pragma omp task default(shared) depend(in : QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, A[0], B, B[0], C, C[0])
        {
...
#pragma omp task default(shared) depend(in : B, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, C, C[0])
      {
...
#pragma omp taskgroup
  {
    ...
    PTR RowIncrementC = RowWidthC - QuadrantSize << 3;
    if (MatrixSize <= bots_app_cutoff_value) {
#pragma omp task default(shared) depend(in : A, B, C, MatrixSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A[0], B[0], C[0])
      MultiplyByDivideAndConquer(C, A, B, MatrixSize, RowWidthC, RowWidthA, RowWidthB, 0);
#pragma omp taskwait
      goto __apac_exit;
    }
...
#pragma omp task default(shared) depend(in : A, B, Depth, QuadrantSize, RowWidthA, RowWidthB) depend(inout : A[0], B[0], Heap)
    OptimizedStrassenMultiply(M2, A, B, QuadrantSize, QuadrantSize, RowWidthA, RowWidthB, Depth + 1);
#pragma omp task default(shared) depend(in : Depth, QuadrantSize) depend(inout : A, B, Heap)
    {
...
#pragma omp task default(shared) depend(in : Depth, QuadrantSize, RowWidthA, RowWidthB, RowWidthC) depend(inout : A, B, C, C[0])
    {
